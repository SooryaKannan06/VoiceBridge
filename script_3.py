...
# Create updated requirements.txt with ONLY free libraries
free_requirements = '''# Voice Bridge - FREE VERSION Dependencies
# NO PAID APIs OR GOOGLE CLOUD REQUIRED!
...
# FREE Speech and Translation Libraries (NO API KEYS NEEDED!)
...
# Create updated README for FREE version
free_readme = '''# 🌉 Voice Bridge - FREE VERSION (No Payment Required!)
...
print("✅ Created FREE requirements.txt and README.md!")
print("📦 Only FREE libraries - NO Google Cloud payment needed!")
